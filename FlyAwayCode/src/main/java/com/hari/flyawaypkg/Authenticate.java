...
public class Authenticate extends HttpServlet {
	...
	//define the db string connection
			...
			String strconn = "jdbc:mysql://localhost:3306/airlineticket?serverTimezone=UTC";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		strsql = "SELECT * FROM airlineticket.tblLogin WHERE UserName = '"+name+ "'";
		...
		try {
			...
			System.out.println("Can't load records - " + e.getMessage());
		}
