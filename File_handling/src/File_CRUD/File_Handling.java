...
System.out.println("      Developer Name : HARI PRASADH \n");    
while(itt=='y') 
{	itt2='y';
	System.out.println("\n      MAIN MENU     \n");
    ...
    case "2":
             while(itt2=='y')
             {
            	 System.out.println("\n      SUB MENU\n"+
            		 ...
            		 "2c. Search a file\n"+
            		 "2d. Go to Main Menu");
            	 System.out.println("Choose any-one operation from 2a, 2b, 2c and 2d : ");
            	 ...
            	 { 
            	 	case "2a":
            	 		...
            	 		break;
            	 	case "2b":
            	 		System.out.println("Enter the directory where you want to delete the file : ");
            	 		String dirr=sc.nextLine();
            	 		System.out.println("Enter the filename.extension of the file which you want to delete : ");
